...
cursor.execute(r"""
    INSERT INTO "FinanceMiCapitalMetrics" (
        period_id,
    ...
    SELECT 
        fmp.id,
        (management_index_data->> 'capital_stock_summary_of_business_results')::BIGINT,
        management_index_data->> 'capital_stock_summary_of_business_results_unit_ref'
    ...
    WHERE 
        management_index_data->> 'capital_stock_summary_of_business_results' IS NOT NULL
        OR management_index_data->> 'capital_stock_summary_of_business_results_unit_ref' IS NOT NULL
""")

close_connection(conn, cursor)

print("✅ FinanceMiCapitalMetrics data inserted.")
